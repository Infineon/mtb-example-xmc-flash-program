...
[Provide feedback on this code example.](https://cypress.co1.qualtrics.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
- [XMC1400 boot kit](https://www.infineon.com/cms/en/product/evaluation-boards/kit_xmc14_boot_001/) (`TARGET_KIT_XMC14_BOOT_001`)
...
The following example will clone the "[Flash program](https://github.com/Infineon/mtb-example-xmc-flash-program)" application with the desired name "Flash_program" configured for the *KIT_XMC47_RELAX_V1* BSP into the specified working directory, *C:/mtb_projects*:
